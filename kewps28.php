...
class MYPDF extends TCPDF {
  public function Header() {
    ...
    $this->Cell(0,5,'AM 6.9 Lampiran J',0,1,'R');

    // Form code
    $this->SetFont('helvetica','B',12);
    $this->Cell(0,6,'KEW.PS-28',0,1,'R');

    // Titles
    $this->Ln(2);
    $this->SetFont('helvetica','B',13);
    $this->Cell(0,7,'JADUAL SEBUT HARGA PELUPUSAN STOK',0,1,'C');
...
$pdf->SetTitle('KEW.PS-28 – JADUAL SEBUT HARGA PELUPUSAN STOK');
...
<table width="100%" cellpadding="5" cellspacing="0">
  <tr>
    ...
    <td class="th b" width="55%">Kod Penyebut Harga</td>
